...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $interesado = $_POST['interesado'] ?? null;
    $cliente = $_POST['cliente'] ?? null;
    $rellamar = $_POST['rellamar'] ?? null;
    $logo_file_path = $_POST['logo_file_path'] ?? null;
    $imagen_file_path = $_POST['imagen_file_path'] ?? null;
    $fecha_inicio = $_POST['fecha_inicio'] ?? null;
    $fecha_fin = $_POST['fecha_fin'] ?? null;
    $comentarios = $_POST['comentarios'] ?? null;
    $recibir_newsletter = $_POST['recibir_newsletter'] ?? null;
    $quiere_vip = $_POST['quiere_vip'] ?? null;
    $quiere_web_lotoluck = $_POST['quiere_web_lotoluck'] ?? null;
    $pagina_compradores = $_POST['pagina_compradores'] ?? null;
...
insertarAdministracion(
	$id_administracion, $activo, $descripcion_interna, $status,
	$veces_activo, $veces_premio, $fecha_alta, $familia,
	$nombre, $nombre_actv, $slogan, $slogan_actv, $envia,
	$titular, $nif_cif, $banco, $cuenta_bancaria,
	$desp_receptor_num, $desp_operador_num, $admin_num, $admin_num_actv,
	$direccion, $direccion_actv, $direccion2, $direccion2_actv,
	$lat, $lon, $poblacion, $poblacion_actv, $provincia,
	$provincia_actv, $cod_pos, $cod_pos_actv, $telefono,
	$telefono_actv, $telefono2, $telefono2_actv, $fax, $fax_actv,
	$email, $email_actv, $web, $web_actv, $web_externa,
	$web_externa_actv, $web_ext_titulo, $web_es_externa, $agente_comercial,
	$contactado, $fecha_contacto, $interesado, $cliente,
	$rellamar, $logo_file_path, $imagen_file_path, $fecha_inicio,
	$fecha_fin, $comentarios, $recibir_newsletter, $quiere_vip,
	$quiere_web_lotoluck, $pagina_compradores, $creado_por,
