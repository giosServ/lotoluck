      ...
      ofrecerte una navegación de calidad y respetuosa.
        ...
        <div align="center" style="border-top: ridge; border-left: ridge; border-right: ridge; margin-top: 10px; margin-left: 0px; margin-right: 0px; border-radius:25px; border-bottom: 2px solid #9a9a9a; width:1000px">
            ...
            <div class="container">
                        ...
                        <tr> 
                            <td>
                                <table>
                                    ...
                                    <tr> <td> <input type="text" id="alias" name="alias" required class="w-full px3 py-2 border border-gray-200" style="width:200;"> </td> </tr>
                                </table>
                            </td>
                ...
                <form action="form.php" method="post" class="w-full flex-col px-0 py-0">
                        ...
                        <tr> 
                            ...
                            <td>
                                ...
                                <table style="margin-top:15px">
                                    ...
                                    <tr> <td> <input type="nombre" name="nombre" required class="w-full px3 py-2 border border-gray-200" style="width:200;"> </td> </tr>
                                </table>
                            </td> 
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr> <td> <input type="apellidos" name="apellidos" required class="w-full px3 py-2 border border-gray-200" style="width:200;"> </td> </tr>
                                </table>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                ...
                                <table>
                                    ...
                                    <tr> <td> <input type="correo" name="correo" required class="w-full px3 py-2 border border-gray-200" style="width:200;"> </td> </tr>
                                    <tr> <td> <label for""> Contraseña </label> </td> </tr>
                                    <tr> <td> <input type="pwd" name="pwd" required class="w-full px3 py-2 border border-gray-200" style="width:200;"> </td> </tr>
                            ...
                            <td>
                                ...
                                <table>
                                    ...
                                    <tr> <td> <input type="pwd" name="pwd2" required class="w-full px3 py-2 border border-gray-200" style="width:200;"> </td> </tr>
                    ...
                    <div align="right">
                        <button type="Submit" style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #e1c147; border-radius: 10px; padding: 10px; margin: 20px; width:150px'> Crear usuario </button>
                    </div>
        ...
        <script type="text/javascript">
            ...
            {
                alert("Verificando alias");

                var alias= document.getElementById("alias").value;
                
                if (alias=='')
                {       alert("Tienes que introducir un alias");    }
                else
                {  
                    $.ajax({
                                    url: "/form.php?alias=raul",
                                    type: "GET",
                                    //data: '{"alias":"prueba"}',
                                    success: function(data){
                                        alert("hemos recibido respuesta===>"+data);
                                    },
