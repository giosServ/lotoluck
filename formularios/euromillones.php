<?php
	...
	if (isset($_POST['type'])) {
		...
		$datos = $_GET['datos'];
		list($accion, $idSorteo, $c1, $c2, $c3, $c4, $c5, $estrella1, $estrella2, $estrella3, $millon, $data,$lluvia_millones) = explode (",", $datos);
		// La variable acción nos permite saber que acción se ha de realizar
		switch ($accion) {
			case '1':
				// Se quiere insertar el juego
				echo json_encode(InsertarSorteoEuromillones($c1, $c2, $c3, $c4, $c5, $estrella1, $estrella2, $estrella3, $millon, $data, $lluvia_millones));
				break;

			case '2':
				// Se quiere actualizar el juego
				echo json_encode(ActualizarSorteoEuromillones($idSorteo, $c1, $c2, $c3, $c4, $c5, $estrella1, $estrella2, $estrella3, $millon, $data, $lluvia_millones));
				break;

			case '4':
				// Se quiere eliminar el juego
				echo json_encode(EliminarSorteoEuromillones($idSorteo));
				break;
