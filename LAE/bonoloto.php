	...
	<body>
		...
		<div align="center">
			...
			<p style='font-family:monospace; font-size:24px;color:#1a8b43'>
				<b>
					Sorteo del Bonoloto de la Once del 
					...
					<?php 
						...
						$fechaAnterior = MostrarFechaAnterior($fechaBD,6);
						...
						$fechaAnterior = $cadA;
            			$fechaPosterior = MostrarFechaPosterior($fechaBD,6);
						if ($fechaPosterior != '') {
		...
		<div align="right">			
			<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #268b1a69; border-radius: 10px; padding: 10px; width:150px; border-color: #1a8b43;' onclick="location.href='bonoloto.php?fecha=<?php echo $fechaAnterior; ?>'"> Anterior </button> </td>
			...
			?>
				...
				<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #268b1a69; border-radius: 10px; padding: 10px; width:150px; border-color: #1a8b43;' onclick="location.href='bonoloto.php?fecha=<?php echo $fechaPosterior; ?>'"> Siguiente </button> </td>
			<?php 
				}
			?>		
