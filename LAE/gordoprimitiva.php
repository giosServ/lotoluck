	...
	<body>
		...
		<div align="center">
			...
			<p style='font-family:monospace; font-size:24px;color:#1a8b43'>
				<b>
					Sorteo del Gordo De la Primitiva de la LAE del 
					...
					<?php 
						...
						$fechaAnterior = MostrarFechaAnterior($fechaBD,7);
						...
						$fechaAnterior = $cadA;
            			$fechaPosterior = MostrarFechaPosterior($fechaBD,7);
						if ($fechaPosterior != '') {
			...
			<p style='font-family:monospace; font-size:24px'>
				Resultados de <b> Gordo de la Primitiva </b> de otros dias:

				<select name="fechas" id="fechas">
					<?php
						$fechas = MostrarFechasSorteos(7);
		...
		<div align="right">			
			<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #268b1a69; border-radius: 10px; padding: 10px; width:150px; border-color: #1a8b43;' onclick="location.href='gordoprimitiva.php?fecha=<?php echo $fechaAnterior; ?>'"> Anterior </button> </td>
			...
			?>
				...
				<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #268b1a69; border-radius: 10px; padding: 10px; width:150px; border-color: #1a8b43;' onclick="location.href='gordoprimitiva.php?fecha=<?php echo $fechaPosterior; ?>'"> Siguiente </button> </td>
			<?php 
				}
			?>		
		...
		<?php 
			MostrarPremioGordoprimitiva($fechaBD);
		?>
