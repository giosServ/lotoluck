...
<meta name='keywords' content='Euromillones, Loteria nacional, Primitiva, Bonoloto, Quinielas,  Gordo, Gordo Navidad, El Niño, Cupon, Cuponazo, Sueldazo, Super Once, Trio, Loto, 6/49.' />
  ...
  <body style=''>
    <header>
      ...
      <nav class='nav2'>
        <ul>
          ...
          <li class='iconosnav'><img src='Imagenes\iconos\Icono Loteria navidad.png' alt='' width='35' height=''/></li>
          <li class='iconosnav'><img src='Imagenes\iconos\icono Loteria del niño.png' alt='' width='35' height=''/></li>
          ...
          <li class='iconosnav'><img src='Imagenes\iconos\Icono once diario.png' alt='' width='35' height=''/></li>
    ...
    <section>
      <nav class="subnav">
        <ul class="subnavme">
          <li class="subnavmenu"><a href="botes.php" >Botes en juego</a></li>
          <li class="subnavmenu"><a href="#" >Localiza la administración</a></li>
          <li class="subnavmenu"><a href="#" >Encuentra tu Nº Favorito</a></li>
          <li class="subnavmenu"><a href="#" >Anuncia tu administración</a></li>
          <li class="subnavmenu"><a href="#" >Loteria en tu web</a></li>
        </ul>
      </nav>  
    </section>
<!-------------------CONTENIDO------------------->
    <section>
      ...
      <br>
	<form action="../Loto/form_registrarse.php" method="post" name="formulario">
      <article class='formularios'>
          <span class="boxform">
          <label for="name">Nombre</label><br>
              <input type="text" name="nombre" id="nombre" style="width:70%;" class="cajaform"/value="<?php if(isset($_POST['nombre'])){echo $_POST['nombre'];}?>">
          ...
          <p class="textform"> Si vas a jugar Gratis a Euromillones y no quieres que aparezca tu nombre en la relación pública de Participantes, introduce aquí el Alias con el que quieres que te identifiquemos. <br><br>If you are going to play Euromillones for Free and you don’t want your name to appear in the participants’ public list, enter here the nickname you wish to be identified with</p>
          ...
          <label for="name">Contraseña</label><br>
              <input type="password" name="password" id="password" style="width:70%; "class="cajaform"/>
			 
			 
          </span>
          <span class="boxform">
          <label for="name">Confirmar contraseña</label><br>
              <input type="password" name="Confirmar contraseña" id="password2" style="width:70%; "class="cajaform"/>
			  
          </span>

          <span class="boxform">
          <label for="name">Género</label><br>
              <select name="Género" id="genero" style="width:77%; "class="cajaform"/>
          ...
          <input name="recibe_com" type="checkbox" id="recibe_com" checked="checked"/>
