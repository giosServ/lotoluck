...
<html>
	...
	<body>
		...
		<?php  
            ...
            if ($f==1)
            {
            	$fecha=ObtenerFechaAnterior(ObtenerFechaSorteo(5),5);
            }
            elseif ($f==2)
            {
            	$fecha=ObtenerFechaPosterior(ObtenerFechaSorteo(5),5);
            }
            else
            {
	            $cad=substr($f, 0,2);
        ...
        <!-- Mostramos el logo -->
		<div align="center">
			<img src='../imagenes/logos/logo_euromillon.png' style='margin-top: 20px;'>
		 
			<p style='font-family:monospace; font-size:24px;color:#64a4ca'>
				<b>
					Euromillones de Loterias y Apuestas del Estado (LAE) del, 
		...
		<div align="right">
			...
			<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #9dc5de; border-radius: 10px; padding: 10px; width:150px; border-color: #1f7bb3;' onclick="location.href='euromillones.php?fecha=1';"> Anterior </button> </td>
			
			<?php 
				}
			
				if (ObtenerFechaSorteo(9)> $fecha)
				{
			?>

				<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #9dc5de; border-radius: 10px; padding: 10px; width:150px; border-color: #1f7bb3;' onclick="location.href='euromillones.php?fecha=2';"> Siguiente </button> </td>
			<?php 
				}
				else
				{	
			?>
				<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #9dc5de; border-radius: 10px; padding: 10px; width:150px; border-color: #1f7bb3; display:none' onclick="location.href='euromillones.php?fecha=2';"> Siguiente </button> </td>
			<?php 
				}
			?>
		...
		<script type="text/javascript">
			...
			function Buscar()
			{
                ...
                window.location.href = "euromillones.php?fecha=" + fecha;
            }
