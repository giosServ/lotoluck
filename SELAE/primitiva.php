...
<html>
	...
	<body>
		...
		<?php  
            ...
            if ($f==1)
            {
            	$fecha=ObtenerFechaAnterior(ObtenerFechaSorteo(10),10);
            }
            elseif ($f==2)
            {
            	$fecha=ObtenerFechaPosterior(ObtenerFechaSorteo(10),10);
            }
            else
            {
	            $cad=substr($f, 0,2);
		...
		<div align="center">
			...
			<p style='font-family:monospace; font-size:24px;color:#64a4ca'>
				<b>
					La Primitiva de Loterias y Apuestas del Estado (LAE) del, 
			...
			<p style='font-family:monospace; font-size:24px'>
				...
				Resultados de <b> La Primitiva </b> de otros dias:

				<select name="fechas" id="fechas">
					<option value="" disabled selected></option>
					<?php
						$fechas=MostrarFechas(10);
		...
		<div align="right">
			...
			<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #9dc5de; border-radius: 10px; padding: 10px; width:150px; border-color: #1f7bb3;' onclick="location.href='primitiva.php?fecha=1';"> Anterior </button> </td>
			
			<?php 
				}
			
				if (ObtenerFechaSorteo(10)> $fecha)
				{
			?>

				<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #9dc5de; border-radius: 10px; padding: 10px; width:150px; border-color: #1f7bb3;' onclick="location.href='primitiva.php?fecha=2';"> Siguiente </button> </td>
			<?php 
				}
				else
				{	
			?>
				<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #9dc5de; border-radius: 10px; padding: 10px; width:150px; border-color: #1f7bb3; display:none' onclick="location.href='primitiva.php?fecha=2';"> Siguiente </button> </td>
			<?php 
				}
			?>
