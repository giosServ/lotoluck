...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados y premios del Lototurf</title>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'&amp;gt;>
    <meta name='searchtitle' content='Resultados y premios del Lototurf' />
    <meta name='description' content='Resultados y premios del Lototurf' />
    <meta name='keywords' content='lototurf, turf, quintuple plus, quiniela hipica, hipica, carreras caballos, botes, sorteos' />
...
<!------------------SUBNAV--------------------->    
	...
	<?php
		generarBannersResultados(31,10);
	?>
	
<!-------------------CONTENIDO------------------->
    <section>
      
      <h2> <article class='cabecerasJuegos' style='background-color: #e56b1c;;'>
        <img src='Imagenes\logos\Logo lototurf.png' alt='loteria nacional'  class='logocabecerajuegoslototurf' />
        
        <a href='' id='10'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='10'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME LOTOTURF ----------------->
	...
	<p style='font-size: 18px; text-align: center; color: #e56b1c;'>		
			<b> 			
			<?php
				...
				echo "Lototurf de Loterias y Apuestas del Estado del $fecha"; 
			?>			
			</b>			
		</p>
		
		<p style='font-size: 14px; text-align: center;'>		
			Resultados de <b> Lototurf  </b> de otros dias:			
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 10);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 10);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='lototurf.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 10);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='lototurf.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
	 ...
	 <?php
		generarBannersResultados(32,10);
	?>
