...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados y premios del Quinigol</title>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'&amp;gt;>
    <meta name='searchtitle' content='Resultados y premios del Quinigol' />
    <meta name='description' content='Resultados y premios del Quinigol' />
    <meta name='keywords' content='quinigol, quiniela, quinielas, 1X2, la quiniela, peñas, peña quinielas, quinielista, futbol, botes, sorteos' />
...
<!------------------SUBNAV--------------------->    
	...
	<?php
		generarBannersResultados(31,9);
	?>
	
<!-------------------CONTENIDO------------------->
    <section>
      
      <h2> <article class='cabecerasJuegos' style='background-color: #3cb2c6;'>
        <img src='Imagenes\logos\Logo quinigol.png' alt='El Quinigol'  class='logocabecerajuegosquinigol'/>
        
        <a href='' id='9'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='9'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME QUINIGOL----------------->
	...
	<p style='font-size: 18px; text-align: center; color: #3cb2c6;'>		
			<b> 			
			<?php
				...
				echo "El Qunigol de Loterias y Apuestas del Estado del $fecha"; 
			?>			
			</b>			
		</p>
		
		<p style='font-size: 14px; text-align: center;'>		
			Resultados de <b>El Quinigol </b> de otros dias:			
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 9);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnteriorQuiniela($idSorteo, 9);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='quinigol.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguienteQuiniela($idSorteo, 9);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='quinigol.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "quinigol.php?idSorteo=" + idSorteo;
		}
