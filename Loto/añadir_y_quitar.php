...
<!-------------------CONTENIDO------------------->
    <section>
      ...
      <h2 class='cabeceras2'>Personaliza tu página de entrada</h2>
      <br>
      <article class='AvisosLegales'>

        <p>En LotoLuck hemos pensado que la forma más fácil para ver los resultados que más te interesan, es poder personalizar la página de incio con tus resultados favoritos. Para poder personazarlo a tu gusto podrás:</p> 
        <h3><i class='fa fa-minus-circle' aria-hidden='true' style='color: red;'></i>&nbsp;Quitar un juego que no quieras tener en Inicio</h3>
        <p>Para poder quitar un juego de la página de inicio tendremos dos formas de hacerlo:<br><br>
        
        <strong> - Desde la página de inicio,</strong> en el juego que no te interesa ver, podrás encontar un icono para eliminar el juego, como se ve en la captura de pantalla.</li></ul></p><br>
        <img src='Imagenes\QuitarInicio.png' alt='' width='50%'/>
        <br><br>
        <strong> - Desde la página del juego,</strong> una vez accedes a él para ver los premios y resultados, podrás encontrar en la parte de la cabecera dos botones, uno para añadir y otro para quitar, tal como se ve en la captura de pantalla.</li></ul></p><br>
        <img src='Imagenes\AñadirInicio.png' alt='' width='52%'/> 

        <br><br>
        <h3><i class='fa fa-plus-circle' style='color: green;'></i>&nbsp;Añadir un juego que no te aparece en Inicio</h3>
        <p>En el caso de querer visualizar un juego que no ves en la parte de inicio, solo tendrás que entrar a el desde el menú inicial de portada:
        </p>
        <img src='Imagenes\Añadirlogosinicio.png' alt='' width='52%'/>
        <br><br>
        <p>Una vez dentro del juego, en la parte superior de la cabecera del juego, podrás encontar dos botones, uno para Añadir y otro para quitar, tal como se ve en la captura de pantalla.
        </p><br>
        <img src='Imagenes\AñadirInicio.png' alt='' width='52%'/>
        <br><br>

        <p><strong>Recuerda permitir a tu navegador que acepte las cookies para esta web. ¡Así de fácil!</strong></p>
        <br><br><br>
