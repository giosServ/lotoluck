...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados y premios de Euromillones.</title>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'&amp;gt;>
    <meta name='searchtitle' content='Resultados y premios de Euromillones.' />
    <meta name='description' content='Resultados y premios de Euromillones' />
    <meta name='keywords' content='euromillones, euromillón, euromillions, loterias, loteria euromillones, resultados, premios, botes, sorteos' />
...
<!-------------------CONTENIDO------------------->
    <section>
      ...
      <h2> <article class='cabecerasJuegos' style='background-color: #143f65;'>
        <img src='Imagenes\logos\Logo euromillon.png' alt='Euromillones'  class='logocabecerajuegoseuromillon'/>
        
        <a href='' id='4'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
        <a href='' id='4'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME EUROMILLON ----------------->
		...
		<p style='font-size: 18px; text-align: center; color: #143f65;'>		
			<b> 			
			<?php
				...
				echo "Euromillones de Loterias y Apuestas del Estado del $fecha"; 
			?>			
			</b>			
		</p>
		
		<p style='font-size: 14px; text-align: center;'>		
			Resultados de <b> Euromillones  </b> de otros dias:			
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 4);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 4);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='euromillon.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 4);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='euromillon.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "euromillon.php?idSorteo=" + idSorteo;
		}
