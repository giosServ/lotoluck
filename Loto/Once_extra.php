...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados y premios del Cupon extraordiario de la ONCE</title>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'&amp;gt;>
    <meta name='searchtitle' content='Resultados y premios del Cupon extraordiario de la ONCE' />
    ...
    <meta name='keywords' content='cupon, extraordinario, cupon extraordiario, sorteos, once, loteria, resultados, premios, botes' />
...
<!------------------SUBNAV--------------------->    
	...
	<?php
		generarBannersResultados(31,13);
	?>
...
<!-------------------CONTENIDO------------------->
    <section>
      ...
      <h2> <article class='cabecerasJuegos' style='background-color: #319852;'>
        <img src='Imagenes\logos\Logo once extra.png' alt='once diario'  class='logocabecerajuegosextra' />
        
        <a href='' id='13'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='13'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
      </article></h2>
...
<!---------------------FRAME ONCE----------------->
	...
	<p style='font-size: 18px; text-align: center; color: #1a8b43;'>		
			...
			<?php
				...
				echo " Sorteo del Cupón Extraordinario de la Once del $fecha"; 
			?>			
			</b>			
		</p>
		
		<p style='font-size: 14px; text-align: center;'>		
			Resultados de <b> Extraordinario </b> de otros dias:			
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 13);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 13);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='once_extra.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 13);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='once_extra.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
		...
		<b>
			<?php
				MostrarExtraordinario($idSorteo);
			?>
		</b>
		</div>
...
<?php
	generarBannersResultados(32,13);
?>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "once_extra.php?idSorteo=" + idSorteo;
		}
