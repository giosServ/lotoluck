...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados y premios del Cupon diario de la ONCE y la Paga</title>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'&amp;gt;>
    <meta name='searchtitle' content='Resultados y premios del Cupon diario de la ONCE y la Paga' />
    <meta name='description' content='Resultados y premios del Cupon diario de la ONCE y la Paga.' />
    <meta name='keywords' content='cupon,cupon diario,sorteos,once,loteria,resultados,premios,botes' />
...
<!------------------SUBNAV--------------------->    
	...
	<?php
		generarBannersResultados(31,12);
	?>
...
<!-------------------CONTENIDO------------------->
    <section>
      ...
      <h2> <article class='cabecerasJuegos' style='background-color: #319852;'>
        <img src='Imagenes\logos\Logo Once diario.png' alt='once diario'  class='logocabecerajuegosdiario'/>
        
        <a href='' id='12'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='12'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
	  ...
	  <br>
		...
		<p style='font-size: 18px; text-align: center; color: #1a8b43;'>		
			...
			<?php
				...
				echo " Sorteo del Ordinario de la Once del $fecha"; 
			?>			
			</b>			
		</p>
		...
		<div align='center'>		
			...
			<?php
				...
				if ($idSorteoAnterior != -1)
				{
					...
					echo "<a class='boton' style='font-size: 12px' href='once_diario.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 12);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='once_diario.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
	...
	<?php
		generarBannersResultados(32,12);
	?>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "once_diario.php?idSorteo=" + idSorteo;
		}
