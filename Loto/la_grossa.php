...
<html class='wide wow-animation' lang='en'>
  <head>
    ...
    <meta name='searchtitle' content='Resultados y premios de La Grossa' />
    ...
    <meta name='keywords' content='La Grossa, lotto, loto, loteria, loteria de catalunya, sorteo, sorteos, resultados, premios, botes, sorteos.' />
...
<!------------------SUBNAV--------------------->    
	...
	<?php
		generarBannersResultados(31,22);
	?>
<!-------------------CONTENIDO------------------->
    <section>
      
      <h2> <article class='cabecerasJuegos' style='background-color: #198b43;'>
        <img src='Imagenes\logos\Logo la grossa.png' alt='La Grossa'  class='logocabecerajuegosgrossa'/>
        
        <a href='' id='22'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='22'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME LA GROSSA	----------------->
	...
	<p style='font-size: 18px; text-align: center; color: #1a8b43;'>		
			...
			<?php
				...
				echo " La Grossa de Loteria de Catalunya del $fecha"; 
			?>			
			</b>			
		</p>
		...
		<p style='font-size: 14px; text-align: center;'>		
			...
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 22);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 22);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='la_grossa.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 22);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='la_grossa.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
	...
	<?php
		generarBannersResultados(32,22);
	?>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "la_grossa.php?idSorteo=" + idSorteo;
		}
