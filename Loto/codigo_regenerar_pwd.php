...
<!--------------------MENU----------------------------------->        
        <ul class='desplegable'>
          <li style='float:right; margin-right: 20px;'><a class='boton'>Menú</a>
          <ul>
            <li><a href='Inicio.php'>Inicio</a></li>
            <li><a href='Botes_en_juego.php'>Botes en juego</a></li>
            <li><a href='encuentra_tu_numero.php'>Encuentra tu Nº favorito</a></li>
            <li><a href='localiza_administracion.php'>Localiza la administración</a></li>
            <li><a href='Anuncia_tu_Administracion.php'>Anuncia tu administración</a></li>
            <li><a href='Publicidad.php'>Publicidad</a></li>
            <li><a href='loteria_en_tu_web.php'>Loteria en tu web</a></li>
            <li><a href='Contacta.php'>Contacta</a></li>
          </ul></li>
<!------------------------------->  
          <li class='logoañadiryquitar'><a href='añadir_y_quitar.php'> <img src='Imagenes\iconos\Icono_AñadirQuitar.png' alt='añadir y quitar' width='50'/></a></li>

          <li class='googleplay'><a href='https://play.google.com/store/apps/details?id=com.lotoluck.lotoluck' target='_blank'><img src='Imagenes\Logos\Logo Google.png' alt='googleplay' width='130'/></a></li>

          <li class='icogoogleplay'><a href='https://play.google.com/store/apps/details?id=com.lotoluck.lotoluck' target='_blank'><img src='Imagenes\Logos\iconoGoogle.png' alt='googleplay' width='30'/></a></li>
...
<!-------------------CONTENIDO------------------->
<input type='text' id='email' style='display:none;' value =''/>
<input type='text' id='reenvio' style='display:none;' value =''/>
<input type='text' id='clave' style='display:block;' value =''/>
<h2 class="cabeceras2">Verificación de identidad</h2>
<section style="padding-top: 0; display: flex; justify-content: center; align-items: flex-start; height: 30vh;">
    <div style="display: flex; flex-direction: column; align-items: center;">
        <span style="width: 40em; text-align: center;">Para continuar, completa este paso de verificación. Hemos enviado un código a tu e-mail
		<strong><span id='correo'></span></strong> Introdúcelo a continuación</span>
        <div style="width: 20em; margin-top: 1em; display: flex; flex-direction: column; align-items: center;">
            <label for="password"><strong>Código de verificación:</strong></label><br>
            <input type="text" name="clave" id="codigo" style="width: 100%;font-size:22px;text-align:center" class="cajaform" value=''/><br><br>
            <button class="boton" type="button" onclick="checkClave()" style="align-self: center;font-size:20px;">Continuar</button><br><br>
			<button class="boton" type="button" onclick="regenerar_contrasenya()" style="align-self: center;border:none;color:blue; background-color:white">Volver a enviar el código</button>
        </div>
    </div>
	<div style='color:grey;'>
	</div>
</section>
<div  style="padding-top: 0; display: flex; justify-content: center; align-items: flex-start; height: 20vh;;">
	<span id='alerta'style='display:none;'>Hemos enviado un nuevo código de verificación a tu cuente, por favor revisa tu carpeta de spam y/o correo no deseado</span>
...
<!---------------------------PIE-------------------------------->
	...
	$(document).ready(function() {
		...
		var reenvio = localStorage.getItem("reenvio");
		document.getElementById('email').value=email;
		document.getElementById('clave').value=clave;
		document.getElementById('reenvio').value=reenvio;
		document.getElementById('correo').innerHTML=email;
		
		  // Función para verificar el valor de un elemento
		  function verificarValor() {
			var reenvio = $("#reenvio").val();
	...
	function checkClave() {
		...
		if (clave === codigo) {
			...
			// Guardar el email en el almacenamiento local
			localStorage.setItem("email", email);

			// Redireccionar a nueva_contrasenha.php
			window.location.href = "nueva_contrasenha.php";
		}
		else{
			alert('El código introducido no es correcto, si necesitas un nuevo código pulsa el enlace "Volver a enviar el código"')
		}
	}
	...
	function regenerar_contrasenya(){
		
		var email = document.getElementById('email').value;
		//alert(email)
		$.ajax({
		 
			url: "form_regenerar_pwd.php?email=" + email,
			type: "POST",
			success: function(data) {
					...
					$.ajax({
						...
						success: function(response) {
							...
							localStorage.setItem("email", email);
							localStorage.setItem("reenvio", 1);
							localStorage.setItem("clave", data);

							// Redireccionar a la página de destino
							window.location.href = "codigo_regenerar_pwd.php";
						},
						error: function() {
							alert('Ocurrió un error durante la solicitud. Por favor, intenta nuevamente.');
						}
					});
