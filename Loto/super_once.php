...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados y premios del Super Once</title>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'&amp;gt;>
    <meta name='searchtitle' content='Resultados y premios del Super Once' />
    <meta name='description' content=' Resultados del sorteo del Super Once Buscador de Resultado de loterias, apuestas y puntos de venta de SELAE, ONCE y Loteria de Catalunya. Escaneo de resguardos y premios.' />
    <meta name='keywords' content='Super Once,cupon,sorteo,once,loteria,cuponazo de la once,sorteos de la once,resultados,premios,botes' />
...
<!------------------SUBNAV--------------------->    
	...
	<?php
		generarBannersResultados(31,17);
	?>
	
<!-------------------CONTENIDO------------------->
    <section>
      
      <h2> <article class='cabecerasJuegos' style='background-color: #319852;'>
        <img src='Imagenes\logos\Logo once super once.png' alt='once diario'  class='logocabecerajuegossuperonce'/>
        
		<a href='' id='17'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='17'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME SUPER ONCE ----------------->
	<br>
	<p style='font-size: 18px; text-align: center; color: #dd3740;'>		
			<b> 			
			<?php
				...
				echo "SuperOnce de la ONCE del $fecha"; 
			?>			
			</b>			
		</p>
		
		<p style='font-size: 14px; text-align: center;'>		
			Resultados de <b> SuperOnce </b> de otros dias:			
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 17);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 17);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='super_once.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 17);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='super_once.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
		...
		<b>
			<?php
				...
				MostrarSuperOnce($sorteos[2],$sorteos[1],$sorteos[0]);
			?>
		</b>
		</div>
		...
		<tr> <td colspan=8 style='color: white; background-color: #246d3b; padding: 10px; text-align:center;'> Tabla de premios del Super Once </td> </tr>
		<tr> <td colspan=8 style='color: white; background-color: #246d3b; padding: 10px; text-align:center;width:10%;'> Importe del premio por apuesta efectuada por sorteo </td> </tr>
		<tr > <td rowspan=2 style='color: white; background-color: #319852; padding: 10px; text-align:center;'> Número de aciertos </td>
		<td colspan=7 style='color: white; background-color: #319852; padding: 10px; padding-left:20em; text-align:left;'> Tipo de apuesta </td></tr>
		<tr>
		<td style='color: white; background-color: #319852; padding: 10px; text-align:center;'> 11 </td>
		<td style='color: white; background-color: #319852; padding: 10px; text-align:center;'> 10 </td>
		<td style='color: white; background-color: #319852; padding: 10px; text-align:center;'> 9 </td>
		<td style='color: white; background-color: #319852; padding: 10px; text-align:center;'> 8 </td>
		<td style='color: white; background-color: #319852; padding: 10px; text-align:center;'> 7 </td>
		<td style='color: white; background-color: #319852; padding: 10px; text-align:center;'> 6 </td>
		<td style='color: white; background-color: #319852; padding: 10px; text-align:center;'> 5 </td> </tr>
		
		
		<tr style='border-bottom:1px dashed black;'>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'><b>11  </td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'> x1.000.000 €</td>
		...
		<tr style='border-bottom:1px dashed black;'>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'><b>10  </td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'> x50.000 €</td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'> x300.000 €</td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'> </td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
		...
		<tr style='border-bottom:1px dashed black;'>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'><b>9  </td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'> x1.000 €</td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'> x5.000 €</td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'>x60.000 €</td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'> </td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
		...
		<tr style='border-bottom:1px dashed black;'>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'><b>3  </td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px;; margin: 20px; border-bottom: 1px dashed black;'></td>
		...
		<tr style='border-bottom:1px dashed black;'>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'><b>2  </td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
		...
		<tr style='border-bottom:1px dashed black;'>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'><b>1  </td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'></td>
		...
		<tr style='border-bottom:1px dashed black;'>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'><b>0  </td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'>x2 €</td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'>x2 €</td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'>x2 €</td>
			<td style='font-size: 16px; text-align: center; color: #4d4d4d; padding: 10px; margin: 20px; border-bottom: 1px dashed black;'>x1 €</td>
	...
	<?php
		generarBannersResultados(32,17);
	?>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "super_once.php?idSorteo=" + idSorteo;
		}
