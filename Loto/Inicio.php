...
<body>
	...
	<div id="lotoluckcontent" style='padding-left-left:0;'>
		<div id="results" class="lotoluck_page active_page">
		...
		<div id="loteria_nacional" class="lotoluck_page "><?php __DIR__ . 'loteria_nacional.php?idSorteo=-1'; ?></div>
		<div id="loteria_navidad" class="lotoluck_page "><?php __DIR__ . 'loteria_navidad.php?idSorteo=-1'; ?></div>
		<div id="loteria_niño" class="lotoluck_page "><?php __DIR__ . 'loteria_niño.php?idSorteo=-1'; ?></div>
	</div>
	...
	<footer>
		<nav class='nav2'>
			<ul>
				...
				<il><a href="#" class="menubutton menuselected" pageid="page_home">Inicio</a></il>
				<il><a href="#" class="menubutton" pageid="page_mission">MISIÓN</a></il>
				<il><a href="#" class="menubutton" pageid="page_news">NOTICIAS</a></il>
				<il><a href="#" class="menubutton" pageid="page_med">CuantumMED</a></il>
			</ul>
		</nav>
