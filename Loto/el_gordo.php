...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados y premios del Gordo de la Primitiva.</title>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'&amp;gt;>
    <meta name='searchtitle' content='Resultados y premios del Gordo de la Primitiva.' />
    <meta name='description' content='Resultados y premios del Gordo de la Primitiva.' />
    <meta name='keywords' content='gordo, gordo primitiva, loteria, loteria, resultados, premios, botes' />
...
<?php
		generarBannersResultados(31,7);
	?>
	
<!-------------------CONTENIDO------------------->
    <section>
      
      <h2> <article class='cabecerasJuegos' style='background-color: #d2200c;'>
        <img src='Imagenes\logos\Logo el Gordo.png' alt='El gordo de la primitiva'  class='logocabecerajuegosgordo'/>
        
        <a href='' id='7'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='7'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>

      </article></h2>
		<br>


<!---------------------FRAME EL GORDO DE LA PRIMITIVA ----------------->
	...
	<p style='font-size: 18px; text-align: center; color: #d2200c;'>		
			...
			<?php
				...
				echo "El Gordo de Loterias y Apuestas del Estado del $fecha"; 
			?>			
			</b>			
		</p>
		...
		<p style='font-size: 14px; text-align: center;'>		
			...
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 7);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 7);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='el_gordo.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 7);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='el_gordo.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "el_gordo.php?idSorteo=" + idSorteo;
		}
