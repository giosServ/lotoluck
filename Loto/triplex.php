...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados y premios del Triplex</title>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'&amp;gt;>
    <meta name='searchtitle' content='Resultados y premios del Triplex' />
    <meta name='description' content='Resultados y premios del Triplex Buscador de Resultado de loterias, apuestas y puntos de venta de SELAE, ONCE y Loteria de Catalunya. Escaneo de resguardos y premios.' />
    <meta name='keywords' content='triplex,cupon,sorteo,once,loteria,sorteos,sorteos de la ONCE,resultados,premios,botes,sorteos' />
...
<!------------------SUBNAV--------------------->    
	...
	<?php
		generarBannersResultados(31,18);
	?>
...
<!-------------------CONTENIDO------------------->
    <section>
      ...
      <h2> <article class='cabecerasJuegos' style='background-color: #319852;'>
        <img src='Imagenes\logos\Logo once triplex.png' alt='once diario'  class='logocabecerajuegostriplex'/>
        
        <a href='' id='18'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='18'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME TRIPLEX ----------------->
	...
	<p style='font-size: 18px; text-align: center; color: #319852;'><br>		
			<b> 			
			<?php
				...
				echo "Triplex de la ONCE del $fecha"; 
			?>			
			</b>			
		</p>
		
		<p style='font-size: 14px; text-align: center;'>		
			Resultados de <b> Triplex </b> de otros dias:			
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 18);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 18);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='triplex.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 18);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='triplex.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
		...
		<b>
			<?php
				...
				MostrarTriplex($sorteos[2],$sorteos[1],$sorteos[0]);
			?>
		</b>
		</div>
	...
	<?php
		generarBannersResultados(32,18);
	?>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "triplex.php?idSorteo=" + idSorteo;
		}
