...
<!-------------------CONTENIDO------------------->
    <section>
      ...
      <h2 class='cabeceras2'>Encuentra tu Nº favorito de Loteria Nacional</h2>
      <p style='text-align: center;'><strong style='font-size:17px ;'>¿Qué número de loteria estás buscando?</strong><br><br>    
      Selecciona el día del sorteo que quieras y localiza la Administración española que lo tiene a la venta</p><br><br>

      <article class='formularios2'>
        <div class='contenedorbusqueda'>
          <form id='formularioNacional' action="../prueba_futuros.php" method='post' target='contenido'>
          <div style='float:left'>
            <img src='Imagenes\iconos\icono Loteria Nacional.png' alt='Loteria Nacional' class='logobusquedas' />
          </div>

          <div class='contenedornumero'>
            <span class='textobusquedas'><strong>Loteria Nacional</strong></span>
            <br><br>
          
              <input type='text' name='numeroNacional' id='numeroNacional' style='width:100%;' class='cajaform'/><br><br>
              <select  id='sorteo' name='sorteo' style='width:100%; 'class='cajaform'/>
              <option value='0'>Elige el dia</option>
             <?php
				mostrarOpcionesSorteoFuturoNacional();
			 ?>
              </select><br><br>
              <button class='boton' type='button' onclick='comprobarNumeroNacional()'>Enviar</button>
           </form>
          </div>
        </div>  
<!------------------>
        <div class='contenedorbusqueda'>
          ...
          <div style='float:left'>
            <img src='Imagenes\iconos\icono Loteria navidad.png' alt='Loteria Nacional' class='logobusquedas' />
          </div>

          <div class='contenedornumero'>
            <span class='textobusquedas'><strong>Gordo Navidad 2023</strong></span>
            <br><br>
            <form>
              <input type='text' name='Numero' id='' style='width:90%;' class='cajaform'/><br><br>
...
<!---------------------->
        <div class='contenedorbusqueda'>
          ...
          <div style='float:left'>
            <img src='Imagenes\iconos\icono Loteria del niño.png' alt='Loteria Nacional' class='logobusquedas' />
          </div>

          <div class='contenedornumero'>
            <span class='textobusquedas'><strong>El Niño 2023</strong></span>
            <br><br>
            <form>
              <input type='text' name='Numero' id='' style='width:100%;' class='cajaform'/><br><br>
              <button id='enviarNac'class='boton'>Enviar</button>
            </form>  
          </div>
        </div>
...
<!-----------UNA VEZ SE REALIZA LA BUSQUEDA SE MUESTRA LO SIGUIENTE------> 
        
        <div>
        <hr style='margin-top: 5%; width: 80%; color: #b2b2b2;'><br>
        <p style='text-align: center;'><strong style='font-size:17px ;'>¿Dónde puedo comprar el número?</strong><br><br>
        <!------TABLA ADMINISTRACIONES--------->
	
		<iframe  id="contenido" name="contenido" src='' width='100%'  height='' frameborder="0"  style ='display:none;'onload="resizeIframe()"></iframe>
...
<!---------------------------PIE-------------------------------->
  ...
  function comprobarNumeroNacional() {
	    
    // Obtener los datos del formulario
    var numero = $('#numeroNacional').val();
    var sorteoSeleccionado = $('#sorteo').val().trim();
    var selectElement = document.getElementById("sorteo");
    var fecha = selectElement.options[selectElement.selectedIndex].text;
    ...
    $.ajax({
      type: 'POST', //
      url: '../prueba_futuros.php', 
      data: datos,
      success: function (response) {
      
        console.log('Respuesta del servidor:', response);
        document.getElementById('contenido').src='resultado_encuentra_tu_numero.php?numero=' + numero +'&receptor='+response + '&fecha=' +fecha;
...
function comprobarNumeroNino() {
	    
    // Obtener los datos del formulario
    var numero = $('#numeroNino').val();
    var sorteoSeleccionado = $('#sorteo').val().trim();
    var selectElement = document.getElementById("sorteo");
    var fecha = selectElement.options[selectElement.selectedIndex].text;
