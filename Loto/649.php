...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados y premios de la 6/49</title>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'&amp;gt;>
    <meta name='searchtitle' content='Resultados y premios de la 6/49' />
    <meta name='description' content='Resultados y premios de la 6/49' />
    <meta name='keywords' content='6/49, lotto, loto, loteria, loteria de catalunya, sorteo, sorteos, resultados, premios, botes, sorteos' />
...
<!------------------SUBNAV--------------------->    
	...
	<?php
		generarBannersResultados(31,20);
	?>
	
<!-------------------CONTENIDO------------------->
    <section>
      
      <h2> <article class='cabecerasJuegos' style='background-color: #e21934;'>
        <img src='Imagenes\logos\logo 649.png' alt='La 6/49'  class='logocabecerajuegos649'/>
        
        <a href='' id='20'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='20'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME 649----------------->
<p style='font-size: 18px; text-align: center; color: #e21934;'>		
			<b> 			
			<?php
				...
				echo "Lotto 6/49 de Loteria de Catalunya del $fecha"; 
			?>			
			</b>			
		</p>
		...
		<p style='font-size: 14px; text-align: center;'>		
			...
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 20);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 20);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='649.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 20);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='649.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
	...
	<?php
		generarBannersResultados(32,20);
	?>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "649.php?idSorteo=" + idSorteo;
		}
