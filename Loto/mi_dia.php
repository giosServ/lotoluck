...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados de Once mi dia</title>
    ...
    <meta name='keywords' content='Mi Dia,cupon,sorteo,once,loteria,sorteos,sorteos de la ONCE,resultados,premios,botes,sorteos' />
...
<!------------------SUBNAV--------------------->    
	...
	<?php
		generarBannersResultados(31,19);
	?>
...
<!-------------------CONTENIDO------------------->
    <section>
      ...
      <h2> <article class='cabecerasJuegos' style='background-color: #319852;'>
        <img src='Imagenes\logos\logo once mi dia.png' alt='once diario'  class='logocabecerajuegosmidia'/>
        
        <a href='' id='19'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='19'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME MI DIA ----------------->
	...
	<p style='font-size: 18px; text-align: center; color: #1a8b43;'>		
			...
			<?php
				...
				echo "Mi Dia de la ONCE del $fecha"; 
			?>			
			</b>			
		</p>
		
		<p style='font-size: 14px; text-align: center;'>		
			Resultados de <b> Mi Dia </b> de otros dias:			
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 19);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 19);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='mi_dia.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 19);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='mi_dia.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
	...
	<?php
		generarBannersResultados(32,19);
	?>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "mi_dia.php?idSorteo=" + idSorteo;
		}
