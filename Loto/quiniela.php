...
<html class='wide wow-animation' lang='en'>
  <head>
    <title>Lotoluck | Resultados y premios de la Quiniela</title>
    <meta name='viewport' content='width=device-width, initial-scale=1.0'&amp;gt;>
    <meta name='searchtitle' content='Resultados y premios de la Quiniela' />
    <meta name='description' content='Resultados y premios de la Quiniela' />
...
<!-------------------CONTENIDO------------------->
    <section>
      ...
      <h2> <article class='cabecerasJuegos' style='background-color: #dd3740;'>
        <img src='Imagenes\logos\Logo la quiniela.png' alt='La quiniela'  class='logocabecerajuegosquiniela'/>
        
        <a href='' id='8'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='8'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME QUINIELA ----------------->
	...
	<p style='font-size: 18px; text-align: center; color: #dd3740;'>		
			...
			<?php
				...
				echo "La Quiniela de Loterias y Apuestas del Estado del $fecha"; 
			?>			
			</b>			
		</p>
		...
		<p style='font-size: 14px; text-align: center;'>		
			...
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 8);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnteriorQuiniela($idSorteo, 8);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='quiniela.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguienteQuiniela($idSorteo, 8);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='quiniela.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "quiniela.php?idSorteo=" + idSorteo;
		}
