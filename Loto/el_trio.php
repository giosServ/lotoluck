...
<html class='wide wow-animation' lang='en'>
  <head>
    ...
    <meta name='searchtitle' content='Resultados y premios del Trio' />
    <meta name='description' content='Resultados y premios del Trio. Buscador de Resultado de loterias, apuestas y puntos de venta de SELAE, ONCE y Loteria de Catalunya. Escaneo de resguardos y premios.' />
    <meta name='keywords' content='trio, lotto, loto, loteria, loteria de catalunya, sorteo, sorteos, resultados, premios, botes, sorteos' />
...
<!------------------SUBNAV--------------------->    
	...
	<?php
		generarBannersResultados(31,21);
	?>

<!-------------------CONTENIDO------------------->
    <section>
      
      <h2> <article class='cabecerasJuegos' style='background-color: #eca116;'>
        <img src='Imagenes\logos\Logo el trio.png' alt='El trio'  class='logocabecerajuegostrio'/>
        
        <a href='' id='21'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
		<a href='' id='21'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME EL TRIO ----------------->
<br>
<p style='font-size: 18px; text-align: center; color: #eca116;'>		
			<b> 			
			<?php
				...
				echo "El Trio de Loteria de Catalunya del $fecha"; 
			?>			
			</b>			
		</p>
		
		<p style='font-size: 14px; text-align: center;'>		
			Resultados de <b> El Trio </b> de otros dias:			
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 21);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 21);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='el_trio.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 21);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='el_trio.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
		...
		<b>
			<?php
				...
				MostrarTrio($sorteos[0], $sorteos[1]);
			?>
		</b>
		</div>
...
<?php
		generarBannersResultados(32,21);
	?>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "el_trio.php?idSorteo=" + idSorteo;
		}
