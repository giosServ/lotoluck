...
<!-------------------CONTENIDO------------------->
    <section>
      ...
      <h2> <article class='cabecerasJuegos' style='background-color: #cc9023;'>
        <img src='Imagenes\logos\Logo Loteria Niño.png' alt='loteria nacional'  class='logocabecerajuegoseuromillon' />
        
        <a href='' id='3'><img src='Imagenes\iconos\menos.png' width='25' class='icocabecerajuegos'/></a>
        <a href='' id='3'><img src='Imagenes\iconos\mas.png' width='25' class='icocabecerajuegos'/></a>
...
<!---------------------FRAME LOTERIA EL NIÑO ----------------->
	
		<p style='font-size: 18px; text-align: center; color: #cc9023;'>		
			<b> 			
			<?php
				...
				echo "El Niño de Loterias y Apuestas del Estado del $fecha"; 
			?>			
			</b>			
		</p>
		...
		<p style='font-size: 14px; text-align: center;'>		
			...
			<select name='fechas' id='fechas' style='font-size: 14px; border-width: 1px; border-style: solid; background-color: #F4F4F4; border-color: #666; padding: 0.55em;'>
				<?php
					...
					MostrarFechasSorteos($idSorteo, 3);
				?>			
			</select>	
		...
		<div align='center'>		
			...
			<?php
				...
				$idSorteoAnterior = ObtenerSorteoAnterior($idSorteo, 3);
				if ($idSorteoAnterior != -1)
				{
					// Hay sorteo anterior, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px' href='loteria_niño.php?idSorteo=$idSorteoAnterior'> Anterior </a>";		
				}
				
				$idSorteoSiguiente = ObtenerSorteoSiguiente($idSorteo, 3);
				if ($idSorteoSiguiente != -1)
				{
					// Hay sorteo siguiente, por lo tanto, mostramos el boton
					echo "<a class='boton' style='font-size: 12px; margin-left:10px;' href='loteria_niño.php?idSorteo=$idSorteoSiguiente'> Siguiente </a>";		
				}
			?>			
		</div>
...
<!---------------------------PIE-------------------------------->
	...
	<script type='text/javascript'>
		...
		function Buscar()
		{
			...
			window.location.href = "loteria_niño.php?idSorteo=" + idSorteo;
		}
