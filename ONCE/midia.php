...
<html>
	...
	<body>
        ...
        <!-- Mostramos el logo -->
		<div align="center">
			<img src='../imagenes/logos/logo_midia.png' style='margin-top: 20px;'>
		 
			<p style='font-family:monospace; font-size:24px;color:#1a8b43'>
				<b>
					Sorteo Mi Día de la Once del 
					...
					<?php 
						...
						$fechaAnterior = MostrarFechaAnterior($fechaBD,19);
						...
						$fechaAnterior = $cadA;
            			$fechaPosterior = MostrarFechaPosterior($fechaBD,19);
						if ($fechaPosterior != '') {
			...
			<p style='font-family:monospace; font-size:24px'>
				Resultados de <b> Mi día </b> de otros dias:

				<select name="fechas" id="fechas">
					<?php
						$fechas = MostrarFechasSorteos(19);
		...
		<div align="right">			
			<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #268b1a69; border-radius: 10px; padding: 10px; width:150px; border-color: #1a8b43;' onclick="location.href='midia.php?fecha=<?php echo $fechaAnterior; ?>'"> Anterior </button> </td>
			...
			?>
				...
				<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #268b1a69; border-radius: 10px; padding: 10px; width:150px; border-color: #1a8b43;' onclick="location.href='midia.php?fecha=<?php echo $fechaPosterior; ?>'"> Siguiente </button> </td>
			<?php 
				}
			?>		
		...
		<script type="text/javascript">
			function Buscar()
			{
                ...
                window.location.href = "midia.php?fecha=" + fecha;
            }
