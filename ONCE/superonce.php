...
<html>
	...
	<body>
        <!-- Mostramos el logo -->
		<div align="center">
			<img src='../imagenes/logos/logo_superonce.png' style='margin-top: 20px;'>
		 
			<p style='font-family:monospace; font-size:24px;color:#1a8b43'>
				<b>
					Sorteo del Super Once de la Once del 
					...
					<?php 
						...
						$fechaAnterior = MostrarFechaAnterior($fechaBD,17);
						...
						$fechaAnterior = $cadA;
            			$fechaPosterior = MostrarFechaPosterior($fechaBD,17);
						if ($fechaPosterior != '') {
			...
			<p style='font-family:monospace; font-size:24px'>
				...
				Resultados de <b> Super Once </b> de otros dias:

				<select name="fechas" id="fechas">
					<?php
						$fechas = MostrarFechasSorteos(17);
		...
		<div align="right">
			<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #268b1a69; border-radius: 10px; padding: 10px; width:150px; border-color: #1a8b43;' onclick="location.href='superonce.php?fecha=<?php echo $fechaAnterior;?>';"> Anterior </button> </td>
			<?php 
				if ($fechaPosterior != '')
				{
			?>

				<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #268b1a69; border-radius: 10px; padding: 10px; width:150px; border-color: #1a8b43;' onclick="location.href='superonce.php?fecha=<?php echo $fechaPosterior; ?>'"> Siguiente </button> </td>
			<?php 
				}
			?>			
		...
		<?php 
			MostrarPremioSuperonce($fechaBD);
		?>
		...
		<script type="text/javascript">
			...
			function Buscar()
			{
                ...
                window.location.href = "superonce.php?fecha=" + fecha;
            }
