...
<html>
	...
	<body>
        ...
        <!-- Mostramos el logo -->
		<div align="center">
			<img src='../imagenes/logos/logo_eurojackpot.png' style='margin-top: 20px;'>
		 
			<p style='font-family:monospace; font-size:24px;color:#1a8b43'>
				<b>
					Sorteo del Eurojackpot de la Once del 
					...
					<?php 
						...
						$fechaAnterior = MostrarFechaAnterior($fechaBD,16);
						...
						$fechaAnterior = $cadA;
            			$fechaPosterior = MostrarFechaPosterior($fechaBD,16);
						if ($fechaPosterior != '') {
			...
			<p style='font-family:monospace; font-size:24px'>
				...
				<select name="fechas" id="fechas">
					<?php
						$fechas = MostrarFechasSorteos(16);
		...
		<div align="right">			
			<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #268b1a69; border-radius: 10px; padding: 10px; width:150px; border-color: #1a8b43;' onclick="location.href='eurojackpot.php?fecha=<?php echo $fechaAnterior; ?>'"> Anterior </button> </td>
			...
			?>
				...
				<button style='text-align: center; font-family: monospace; font-size: 12; font-weight: bold; background: #268b1a69; border-radius: 10px; padding: 10px; width:150px; border-color: #1a8b43;' onclick="location.href='eurojackpot.php?fecha=<?php echo $fechaPosterior; ?>'"> Siguiente </button> </td>
			<?php 
				}
			?>		
		...
		<?php 
			MostrarPremioEurojackpot($fechaBD);
		?>
		...
		<script type="text/javascript">
			function Buscar()
			{
                ...
                window.location.href = "eurojackpot.php?fecha=" + fecha;
            }
