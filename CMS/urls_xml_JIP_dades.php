...
<html>
	...
	?>
		...
		<div class="titulo">
			...
			<table width="100%">
				<tr>	
					<td class="titulo"> Enlaces Lotoluck App JIP + / Edición</td>
					<td class="titulo" stye="text-align:right;" > ID: <?php echo $id?></td>
				</tr>
			</table>

		</div>
		<form action='../formularios/urls_xml_JIP.php' method='post'>
		...
		<input type='text' style='display:none;' name='id' value='<?php echo $id?>' />
			...
			<table style='width:100%;text-align:right;'>
				<tr>
					...
					<td width='20px'>&nbsp;</td>
					<td width='30px'> <a class='cms_resultados' href="../CMS/urls_xml_JIP.php"><button class='botonAtras' type='button'> Atrás</button> </a> </td>
				</tr>
			</table>
