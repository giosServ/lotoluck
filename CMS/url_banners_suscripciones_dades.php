...
<html>
	...
	?>
		...
		<div class='titulo'>
			...
			<table>
				<tr>
					<td class='titulo'> Nueva URL para Suscripciones </td>
				</tr>
			</table>
		...
		<div style="text-align:right; padding-top: 20px;">			
      		...
      		<button class="botonGuardar" id="guardar" name="guardar" onclick="Guardar()"> Guardar </button>
      		 <a class="links" href="url_banners_suscripciones.php"><button class="botonAtras" id="atras" name="atras"> Atrás </button> </a>
		...
		<?php
			echo "<table style='width:100%;margin-left:20px;'>";
				if($id_url!=-1){
					...
					mostrarUrlSuscripciones($id_url);
				}
				else{
				...
				var url = document.getElementById('url').value;
					...
					if (id!=-1)
					{
						...
						$.ajax(
						{
							...
							// Definimos la url
							url:"../formularios/url_banners_suscripciones.php?datos=" + datos,
							type: "POST",
							...
							success: function(data)
							{
								...
								{	alert("Se han actualizado los datos.");
									window.location.href='url_banners_suscripciones.php';
								}
							}
						});																
