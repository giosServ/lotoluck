		...
		<div style="margin-top:20px;">
			...
			<?php
				if ($idSorteo <> -1) {
					...
					echo '<textarea id="textoBanner" style="margin-top: 10px; width:950px;height:270px;">';echo obtener_ultimo_txtBanner(2); echo '</textarea>';
				}
			?>	
		...
		<div style="margin-top:20px;">
			...
			<?php
				if ($idSorteo <> -1) {
					...
					echo '<textarea id="comentario" style="margin-top: 10px; width:950px;height:270px;">';  echo obtener_ultimo_comentario(2); echo '</textarea>';
				}
			?>
		</div>
		</div>
