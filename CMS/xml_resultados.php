...
<html>
	...
	?>
		...
		<div class='titulo'>
			...
			<table>
				<tr>
					<td class='titulo'>XML - Resultados</td>
					<td width="30%"> </td>
		...
		<table width="90%" style="margin-top:60px; margin-left:20px;">
			<tr>
				<td style="text-align:center; width: 50%;"><label type="button" style="font-weight: bold; padding: 10px; border-radius: 10px; background: #555555;color:white;">Buscar por Juego y Fecha</label></td>
				<td style="text-align:center;  width: 50%;"><label type="button" style="font-weight: bold; padding: 10px; border-radius: 10px; background: #555555; color: white;">Buscar por Fecha</label></td>
			</tr>
			<tr><td height="20px"></td></tr>
			<tr style="margin-top: 40px;">
			<td style="text-align:center; margin-top: 40px;">
				<form target="_blank" method="post" action="../utils/lotoluck_en_xml.php" name="formulario1">
					...
					<select type="number" name="juego" style="height: 2em; margin-left: 1em;width: 10em;"class="cms">
						<?php
							juegosApp();
						?>
					</select>
					<input type="date"  id="data1" style="height: 2em; margin-left: 1em;width: 10em;"class="cms" >
					<input type="hidden"  id="fecha1" name="fecha" style="height: 2em; margin-left: 1em;width: 10em;"class="cms" >
					<button type="button" style="font-weight: bold; padding: 10px; border-radius: 10px; background: #e1c147;" name="buscar" id="buscar" onclick="enviarForm1()">Generar XML</button>
			...
			<td style=" text-align:center; ">
				<form target="_blank" method="post" name="formulario2" action="../utils/lotoluck_en_xml.php" >
					
					<input type="hidden" name="username" style="height: 2em; margin-left: 1em;width: 20em;"class="cms" value ="lotoluck_int">
					<input type="hidden"  name="password" style="height: 2em; margin-left: 1em;width: 20em;"class="cms" value ="lotoluck_int">
		
					<input type="date"  id="data2" style="height: 2em; margin-left: 1em;width: 10em;"class="cms" >
