<!-- 
	Página que nos permite mostrar todos los sorteos de LAE - La Quiniela guardados en la BBDD
-->
	...
	?>
		...
		<div class='titulo'style='margin-bottom:1em;'>
			...
			<table>
				<tr>
					...
					<td width="30%"> </td>
					<td>
						<a href='quiniela_dades.php?idSorteo=-1' ><button class='cms' style='width:175px;color:black;'>Nuevo sorteo </button></a>
					</td>
				</tr>
			</table>
		</div>
		...
		<div>
			...
			<thead>	
				...
				<td class="cabecera"> 7 </td>
				<td class="cabecera"> 8 </td>
				<td class="cabecera"> 9 </td>
				<td class="cabecera"> 10 </td>
				<td class="cabecera"> 11 </td>
				<td class="cabecera"> 12 </td>
				<td class="cabecera"> 13 </td>
				<td class="cabecera"> 14 </td>
				<td class="cabecera"> 15 </td>
