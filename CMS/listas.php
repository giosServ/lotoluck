	...
	?>
		...
		<div style='width:98%;'>
			...
			<table id='tabla' class="sorteos"  width='100%' style='margin-top:0;'>
				...
				<thead>
					<th class='cabecera'  width='5%'> ID </th>
					<th class='cabecera'style='text-align:left;' > Nombre</th>
					<th class='cabecera'style='text-align:left;' > Comentarios</th>
		...
		<div id='nueva_lista' class='nuevaListaCorreos'>
			<hr><hr>
			<br>
			<form action = '../formularios/listas.php' id='formulario' >
			<table style='width:100%; marging-top:2em;margin-left:20px;'>

				<th style='text-align:left;font-size:20px;'>Nueva lista de direcciones:</th>
				<tr>
					<td style='padding-top:1em;padding-bottom:1em;'> <input type="text" name="nombre" class='cms' style='width:42em;' placeholder="Nombre de la nueva lista"></td>

				</tr>
				<tr>
					<td style='padding-top:1em;padding-bottom:1em;'> <textarea type="text" name="descripcion" class='cms' rows=4 cols=110 placeholder="Descripcion"></textarea></td>
						
						
				</tr>
				<tr>
					<td style='width:100%;text-align: left;'><button type='button' id='filtrar'class='cms' style='margin-bottom:10px;background-color:green;color:white;' onclick="crear()">Crear nueva lista</button>&nbsp;&nbsp;
			...
			function EliminarLista(id_lista)
		{
				...
				if(confirm('¿Seguro que desea eliminar la lista?')){
					...
					{
						// Definimos la url						
						url:"../formularios/listas.php?eliminar=" + id_lista,
						type: "POST",
