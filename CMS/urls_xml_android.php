...
<html>
	...
	?>
		...
		<div class='titulo'style='margin-bottom:1em;'>
			<table>
				<tr>
					<td class='titulo'> Enlaces LotoLuck App Android </td>
					<td width="30%"> </td>
					<td>
						<a class='cms_resultados' href="urls_xml_android_dades.php?id=-1"><button class='cms' style='width:175px; margin-left:100%'> Nuevo</button> </a>
					</td>
				</tr>
			</table>
		</div>
		...
		<script type="text/javascript">
			...
			function EliminarRegistro(id)
			{
				...
				if (confirm("Quieres eliminar el registro? Pulsa OK para eliminara.") == true)
				{
					...
					{
						// Definimos la url
						url:"../formularios/urls_xml_android.php?eliminar_id=" + id,
