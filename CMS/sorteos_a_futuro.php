...
<html>
	...
	?>
		...
		<div class='titulo' style='margin-bottom:1em;'>
			...
			<table>
				<tr>
					<td class='titulo'> LAE - Sorteos a futuro </td>
					<td width="30%"> </td>
					<td><a class='cms_resultados' href="sorteos_futuro_dades.php?id=-1"> 
		...
		<div>
			...
			<thead>
				...
				<td class='cabecera'> Juego LAE</td>
				<td class='cabecera'> LAE ID </td>
				<td class='cabecera'> Código de <br>Fecha LAE</td>
				<td class='cabecera'> Fecha</td>
				<td class='cabecera'> Tipo </td>
				<td class='cabecera' style='width:40%'> Descripción </td>
		...
		<script type="text/javascript">
			...
			function EliminarSorteo(idSorteo)
			{
				...
				if (confirm("Quieres eliminar el sorteo? Pulsa OK para eliminara.") == true)
				{
					...
					{
						// Definimos la url
						url:"../formularios/sorteos_a_futuro.php?eliminar_id=" + idSorteo,
