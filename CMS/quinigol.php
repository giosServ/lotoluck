<!-- 
	Página que nos permite mostrar todos los sorteos de LAE - El Quinigol guardados en la BBDD
-->
		...
		<div class='titulo' style='margin-bottom:1em;'>
			...
			<table>
				<tr>
					...
					<td width="30%"> </td>
					<td>
						<a href='quinigol_dades.php?idSorteo=-1'><button class='cms' style='width:175px; margin-left:100%;color:black;'>Nuevo sorteo</button></a>
					</td>
				</tr>
			</table>
		</div>
