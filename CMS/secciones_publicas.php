...
<!DOCTYPE html>
	...
	?>
		...
		<div class='titulo' style='margin-bottom:1em;'>
			...
			<table width='100%' >
				<tr>
					<td class='titulo'>Secciones públicas Lotoluck.com</td>
					<td width="30%"> </td>
					
					</td>
					<td Style='text-align:center;'> <a class="links" href="secciones_publicas_dades.php?id=-1"> <button class="cms"  style='color:black;'>Nuevo</button> </a>  </td>
				</tr>
			</table>
		...
		<div>
			...
			<thead>
				<tr>
					...
					<th class='cabecera' style='font-size:18px;border:solid 0.5px;border-bottom:solid 2px;background-color: #d5d5d5;'> URL</th>
					<th class='cabecera' style='font-size:18px;border:solid 0.5px;border-bottom:solid 2px;background-color: #d5d5d5;'> Descripción</th>
				...
				<?php
					...
					mostrarListadoSeccionesPublicas();
