...
<!DOCTYPE html>
	...
	?>
		...
		<div class='titulo'style='margin-bottom:1em;'>
				...
				<table> 
					<tr>
						...
						<td width="30%"> </td>
						<td><a class="cms_resultados" href="quintuple_dades.php?idSorteo=-1">
						<button class='cms' style='width:175px; margin-left:100%;color:black;'>  Nuevo sorteo</button>  </a> </td>
					</tr>
				</table>
		...
		<div>
			...
			<thead>	
				<tr>
					<td class="cabecera" style='text-align:center;'> ID </td>
					<td class="cabecera" style='text-align:center;'> Dia </td>
					<td class="cabecera" style='text-align:center;'> Fecha </td>
					<td class="cabecera" style='text-align:center;'> Carreras Ganadoras </td>	
					<td class="cabecera" style='text-align:center;'> Editar </td>	
					<td class="cabecera" style='text-align:center;'> Eliminar </td>
				</tr>
			</thead>	
				<?php 
					MostrarSorteosQuintuple();
				?>
